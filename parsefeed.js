export function parseFeed(xmlText) {
  ...
  if (xml.querySelector("parsererror")) {
    throw new Error("שגיאה בניתוח ה-XML");
  }
  ...
  throw new Error("לא זוהה מבנה פיד נתמך (RSS או Atom)");
}
...
//returns an array of rss links  from the page haber content link and title 
